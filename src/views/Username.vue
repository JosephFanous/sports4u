        ...
        <div class="col-md-9 personal-info">
          <div class="form-horizontal" role="form">
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input v-on:keyup.enter="save" class="input is-dark" type="text" v-model="User" v-bind:placeholder="user">
...
export default{
  ...
  methods:{
    ...
    if (next == true){
      ...
      .then(data =>{
      if(data.success){
        this.$globalStore.user.username = data.Username
        this.$router.push({
          path: '/afterLogin'
        })
        return
      ...
      if (data.errors.User){
        this.usererr = 'This username is taken. Please enter another one.';
      }
      })
    }
  }
